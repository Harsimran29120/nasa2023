...
const whiterMoonUrl = "https://globe.gl/example/moon-landing-sites/lunar_surface.jpg"; 
const terrainMoonUrl = "../moont.png"

let url = "./moon3d.png"
const map = document.getElementById("map");

function changeM1() {
  map3D.globeImageUrl(darkerMoonUrl);
}

function changeM2() {
  map3D.globeImageUrl(whiterMoonUrl);
}

function changeM3() {
  map3D.globeImageUrl(terrainMoonUrl);
}
...
map3D.controls().autoRotateSpeed = 0.17322;
